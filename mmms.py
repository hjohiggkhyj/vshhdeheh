...
bot_token = '7458954920:AAEI8h_kitfe8SW9xzkME34UnpO0lU-nL4E'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['208125100']
admin_id = '208125100'
subscription_data = {}
...
btn_one_day = telebot.types.InlineKeyboardButton('Day يوم', callback_data='duration_1_day')
btn_one_week = telebot.types.InlineKeyboardButton('Week اسبوع', callback_data='duration_1_week')
btn_one_month = telebot.types.InlineKeyboardButton('Month شهر', callback_data='duration_1_month')
btn_one_year = telebot.types.InlineKeyboardButton('Yaer سنه', callback_data='duration_1_year')
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'اهلا بك في بوت الرفع الخارجي المطور ,@c_z_8 ', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'انت غير مشترك في البوت للاشتراك في البوت : @c_z_8')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '208125100':  
